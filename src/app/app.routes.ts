...
export const routes: Routes = [
  ...
  { path: 'users', component: Users, canActivate: [roleauthguardGuard], data: { roles: ['Admin','AdminAssistant'] } },
    { path: 'users/:username', component: Users, canActivate: [roleauthguardGuard], data: { roles: ['Admin','AdminAssistant'] } },
...
{ path: 'deletedordersfeedback/:date', component: Getdeletedorderfeedback, canActivate: [roleauthguardGuard], data: { roles: ['Customer','Staff','AdminAssistant','Admin'] } },
  ...
  { path: 'updateuserinfo', component: Updateuserdetails, canActivate: [roleauthguardGuard], data: { roles: ['Customer','Staff','AdminAssistant','Admin'] } },
  { path: 'restoreaccount', component: Restoreaccount },
  { path: 'resetpassword', component: ResetPassword, canActivate: [roleauthguardGuard], data: { roles: ['Customer','Staff','AdminAssistant','Admin'] } },
